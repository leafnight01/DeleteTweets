var authorization = "Bearer var authorization = "Bearer AAAAAAAAAAAAAAAAAAAAANRILgAAAAAAnNwIzUejRCOuH5E6I8xnZz4puTs%3D1Zv7ttfk8LF81IUq16cHjhLTvJu4FA33AGWWjCpTnA"; // replace by authorization value
var ua = navigator.userAgentData.brands.map(brand => `"${brand.brand}";v="${brand.version}"`).join(', ');
var client_tid = "TQCTsS1DbShY24E7TmOpSsYoMtBG2c2gzrk11E0b2r15am7rpJulAMGYTdY7xNz91T7DIk6tKBldTLS/Umvh1ae6lv/JTg"; // replace by X-Client-Transaction-Id value
var client_uuid = "a414680e-faf1-47fd-a8b6-c64b107f73a1"; // replace by X-Client-Uuid value
...
var username = "leafnight_10" // replace with your username
...
console.log("DELETION COMPLETE (if error happened before this may be not true)")"; // replace by authorization value
var ua = navigator.userAgentData.brands.map(brand => `"${brand.brand}";v="${brand.version}"`).join(', ');
